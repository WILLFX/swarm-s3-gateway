...
required_source = [
    ...
    "is_loopback_remote_gateway_url",
    "AWS4-HMAC-SHA256",
    "authorization",
...
required_tests = [
    ...
    "http_client_rejects_non_loopback_http_base_url",
    "http_client_accepts_loopback_http_base_url_for_dev",
    "http_client_accepts_https_base_url",
