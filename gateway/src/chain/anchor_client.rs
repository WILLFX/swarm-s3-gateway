...
impl AnchorClient for ContractAnchorClient {
    async fn create_bucket_anchor(
        ...
        let input_data = encode_bucket_create_bucket(
            owner,
            bucket_id,
            is_private,
            owner_signature,
        ...
        self.submit_bucket_contract_call(input_data, "bucket::create_bucket")
            .await
    }
    ...
    async fn delete_bucket_anchor(
        ...
        let input_data =
            encode_bucket_delete_bucket(bucket_id, owner_signature, owner_catalog_root);

        self.submit_bucket_contract_call(input_data, "bucket::delete_bucket")
            .await
    }
